...
<?php 
  ...
  $query_show = mysqli_query($conn,"Select tbhyt.id, npp.tenthuoc as 'tenthuoc', tbhyt.soluongton, npp.tencongty as 'tencongty' from thuocbhyt tbhyt right join nhaphanphoi npp on tbhyt.nhaphanphoi = npp.id");
  ...
  $query_show = mysqli_query($conn,"Select tbhyt.id, npp.tenthuoc as 'tenthuoc', tbhyt.soluongton, npp.tencongty as 'tencongty' from thuocbhyt tbhyt right join nhaphanphoi npp on tbhyt.nhaphanphoi = npp.id order by id ASC limit $start,$limit");
  if (isset($_POST['search'])) {
    $search = $_POST['search'];
    $query_show = mysqli_query($conn,"Select tbhyt.id, npp.tenthuoc as 'tenthuoc', tbhyt.soluongton, npp.tencongty as 'tencongty' from thuocbhyt tbhyt right join nhaphanphoi npp on tbhyt.nhaphanphoi = npp.id where npp.tenthuoc like '%$search%' or npp.tencongty like '%$search%'");
  }
 ?>
                ...
                <div class="page-content">
                          ...
                          <div class="row">
                            <div class="card card-default widget">
                              <div class="card-heading">
                                <h3 style="margin-left: -15px;">Danh sách thuốc BHYT</h3>
                              </div>
                    ...
                    <div class="col-md-12">
                      <div class="col-md-3 text-left" style=" margin-top: 20px;float: left;">
                        <a href="danhsachthuoc.php" class="btn btn-info">< Thuốc bán</a>
                      </div>
