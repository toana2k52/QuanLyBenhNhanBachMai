...
<?php 
  ...
  $thanhtien = ($giaphong * $days) - ($giaphong * $days * 0);
  ...
  $tongtiendichvu = $tiendichvu - ($tiendichvu * 0);
              ...
              <div class="col-md-12">
                <div class="card card-default widget">
                  <div class="card-heading">
                    <h3 class="card-title">THANH TOÁN VIỆN PHÍ THƯỜNG</h3>
                  </div>
                  <div class="card-body">
                    <form action="" method="POST" role="form">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-4" style="float: left;">
                            ...
                            <div class="form-group">
                              <label for="">Số thẻ CMND:</label>
                              <input value="<?php echo $socmnd ?>" type="text" class="form-control" id="" placeholder=""> 
                            </div>
                          </div>
                   </form>
                  </div>
                  ...
                  <div class="card-body">
                    <form action="" method="POST" role="form">
                      ...
                      <div class="text-right">
                        <a href="control/xuatkhoa_thuong.php?id=<?php echo $id_benhnhan ?>" id="thanhtoan" type="" class="btn btn-success" style="margin: 0px 5px 0 0;">Thanh toán</a>
